...
export default class NeontoExport0x7faf193d9770Screen extends Component {
  ...
  render() {
    ...
    return (
      <Container fluid={true} className="AppScreen NeontoExport0x7faf193d9770Screen" style={baseStyle}>
