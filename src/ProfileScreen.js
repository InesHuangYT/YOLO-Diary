...
export default class ProfileScreen extends Component {
  ...
  render() {
    ...
    return (
      <Container fluid={true} className="AppScreen ProfileScreen" style={baseStyle}>
        ...
        <div className="screenFgContainer">
          <div className="foreground">
            <div className='font-arialRoundedMTBold  elTextCopy' style={style_textCopy}>
              <div>{this.props.locStrings.start6_textcopy_275516}</div>
            </div>
            <div className='font-arialRoundedMTBold  elText' style={style_text}>
              <div>{this.props.locStrings.start6_text_351684}</div>
            </div>
            <button className='elButtonCopy' style={style_buttonCopy}  >
              {this.props.locStrings.start6_buttoncopy_483188}
            </button>
            <button className='elButton' style={style_button}  >
              {this.props.locStrings.start6_button_519196}
            </button>
            <button className='elButtonCopy2' style={style_buttonCopy2}  >
              {this.props.locStrings.start6_buttoncopy2_244417}
            </button>
            <button className='elButtonCopy3' style={style_buttonCopy3}  >
              {this.props.locStrings.start6_buttoncopy3_353327}
            </button>
            ...
            <button className='elButtonCopy4' style={style_buttonCopy4}  >
              {this.props.locStrings.profile_buttoncopy4_697294}
            </button>
            <Input className='elField' style={style_field} type="text" hint={this.props.locStrings.profile_field_683293} onChange={this.textInputChanged_field} defaultValue={this.state.field}  />
            <Input className='elFieldCopy' style={style_fieldCopy} type="text" hint={this.props.locStrings.profile_field_622560} onChange={this.textInputChanged_fieldCopy} defaultValue={this.state.fieldCopy}  />
          </div>
        </div>
      </Container>
    )
