...
export default class NeontoExport0x7fc75655a6a0Screen extends Component {
  ...
  render() {
    ...
    return (
      <Container fluid={true} className="AppScreen NeontoExport0x7fc75655a6a0Screen" style={baseStyle}>
