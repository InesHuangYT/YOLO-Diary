...
export default class TutorCreateBB2Screen extends Component {
  ...
  render() {
    ...
    return (
      <Container fluid={true} className="AppScreen TutorCreateBB2Screen" style={baseStyle}>
        ...
        <div className="layoutFlow" style={layoutFlowStyle}>
          <div className='font-arialRoundedMTBold  elText' style={style_text_outer}>
            <div style={style_text}>
              <div>{this.props.locStrings.tutorcreatebb2_text_48006}</div>
            </div>
          ...
          <div className='font-arialRoundedMTBold  elTextCopy' style={style_textCopy_outer}>
            <div style={style_textCopy}>
              <div>{this.props.locStrings.tutorcreatebb2_textcopy_659914}</div>
            </div>
          ...
          <div className='elButton' style={style_button_outer}>
            <button style={style_button}  >
              {this.props.locStrings.tutorcreatebb2_button_11550}
            </button>
          ...
          <div className='elButtonCopy' style={style_buttonCopy_outer}>
            <button style={style_buttonCopy}  >
              {this.props.locStrings.tutorcreatebb2_buttoncopy_564312}
            </button>
          ...
          <div className='elButtonCopy2' style={style_buttonCopy2_outer}>
            <button style={style_buttonCopy2}  >
              {this.props.locStrings.tutorcreatebb2_buttoncopy2_578273}
            </button>
          ...
          <div className='elButtonCopy3' style={style_buttonCopy3_outer}>
            <button style={style_buttonCopy3}  >
              {this.props.locStrings.tutorcreatebb2_buttoncopy3_916984}
            </button>
