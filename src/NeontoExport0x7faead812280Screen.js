...
export default class NeontoExport0x7faead812280Screen extends Component {
  ...
  render() {
    ...
    return (
      <Container fluid={true} className="AppScreen NeontoExport0x7faead812280Screen" style={baseStyle}>
